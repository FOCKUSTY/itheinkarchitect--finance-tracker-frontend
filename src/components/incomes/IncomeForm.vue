...
import type { IncomeCreate, IncomeUpdate } from "@/types/models";
import { ref, watch } from "vue";

const props = defineProps<{
  initialData?: IncomeCreate | IncomeUpdate | null;
}>();

const emit = defineEmits<{
  (e: "submit", data: IncomeCreate | IncomeUpdate): void;
  (e: "cancel"): void;
}>();

const form = ref<IncomeCreate | IncomeUpdate>({
  amount: 0,
  category: "",
  description: "",
